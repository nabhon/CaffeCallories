...
import { Flame, Sparkles, User, Activity, Target, ArrowRight, Loader2, Check } from 'lucide-react'
...
export default function OnboardingPage() {
  ...
  if (loading) {
    return (
      <div className="max-w-md mx-auto min-h-screen flex items-center justify-center p-4 bg-background">
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-background border-x border-stone-200/60 dark:border-stone-800/60 flex flex-col justify-between p-4 sm:p-6 pb-12">
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-stone-200 dark:border-stone-800 bg-stone-50/80 dark:bg-stone-900/80 p-4 space-y-3.5 shadow-sm">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-stone-500 dark:text-stone-400 flex items-center gap-1">
              <Sparkles className="h-3.5 w-3.5 text-amber-500" /> Recommended Target
            </span>
            <span className="text-[11px] text-stone-400">BMR: {calculation.bmr} kcal</span>
          </div>
          ...
          <div className="flex items-baseline gap-1.5">
            ...
            <span className="text-xs font-medium text-stone-500">kcal / day</span>
          </div>
      ...
      {/* Save Button Fixed in Thumb Reach */}
      <div className="pt-6">
        <Button
